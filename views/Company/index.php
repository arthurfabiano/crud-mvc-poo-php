...
<body>
    ...
    <div>
        ...
        <!-- <div> <a class="button btn-success" href="./index.php?a=goToNew&c=billstopay">Contas Pagar</a> </div> -->
        <div> <a class="button btn-success" href="./index.php?c=billstopay">Contas Pagar</a> </div>
    </div>
            ...
            <tbody>
                <?php foreach($resultData as $data): ?>
                    <tr>
                        ...
                        <td> <?= $data["name"]; ?> </td>
                        <td> 
                            <a class="button btn-edit" href="./index.php?&c=companies&a=search&v=editCreate&search=<?= $data['id'] ?>">Editar</a>
...
<script>
    function verifyDelete(id)
    {
        ...
        if(result)
        {
            window.location.replace('./index.php?&c=companies&a=delete&id='+id);
        }
    }
    function reload()
    {
